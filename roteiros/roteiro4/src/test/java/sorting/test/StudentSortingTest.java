...
public class StudentSortingTest {
	...
	public void setUp() {
		...
		populaVetorNegativos(new Integer[] {-2, -1, -5, 6, 0, 3, -6});
		getImplementation();
	}
	...
	public void partitionTest(Integer[] array) {
		Integer[] copy1 = {};
		if(array.length > 0){
			copy1 = Arrays.copyOf(array, array.length);			
		}
		implementation.sort(array, 3, 6);
		Arrays.sort(copy1, 3, 7);
		Assert.assertArrayEquals(copy1, array);
	}
	...
	public void testSort09() {
		partitionTest(vetorTamImpar);
	}
	
	@Test
	public void testSort10() {
		implementation.sort(vetorNull, 0, 5);
	}
	
	@Test
	public void testSort12() {
		partitionTest(vetorValoresRepetidos);
	}
